...
const CategoryPage = ({ categoryName = "Headphones", onBack, onNavigate, onProductClick }) => {
  const products = [
    {
      ...
      <div className="category-page__sticky-wrapper">
        ...
        <div className="category-page__filter-bar">
          ...
          <button className="filter-chip">
            Category <svg className="chevron-down" width="12" height="8" viewBox="0 0 12 8" fill="none"><path d="M1 1.5L6 6.5L11 1.5" stroke="#212429" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/></svg>
          </button>
          <button className="filter-chip">
            Brand <svg className="chevron-down" width="12" height="8" viewBox="0 0 12 8" fill="none"><path d="M1 1.5L6 6.5L11 1.5" stroke="#212429" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/></svg>
          </button>
          <button className="filter-chip">
            Price <svg className="chevron-down" width="12" height="8" viewBox="0 0 12 8" fill="none"><path d="M1 1.5L6 6.5L11 1.5" stroke="#212429" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/></svg>
          </button>
        </div>
        ...
        <div className="category-page__sort-bar">
          ...
          <span className="sort-text">
            ...
            <svg className="chevron-down" width="12" height="8" viewBox="0 0 12 8" fill="none" style={{marginLeft: 6}}><path d="M1 1.5L6 6.5L11 1.5" stroke="#212429" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/></svg>
          </span>
        </div>
      </div>
